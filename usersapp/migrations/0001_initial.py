    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.CharField(choices=[('CIT', 'CIT'), ('EEE', 'EEE')], max_length=20)),
                ('user_type', models.CharField(choices=[('Lecturer', 'Lecturer'), ('Student', 'Student')], max_length=20)),
                ('gender', models.CharField(choices=[('Male', 'Male'), ('Female', 'Female')], max_length=6)),
                ('phone', models.CharField(help_text='The phone number should contain 10 digits e.g. 0881850090', max_length=10, unique=True, verbose_name='Phone Number')),
